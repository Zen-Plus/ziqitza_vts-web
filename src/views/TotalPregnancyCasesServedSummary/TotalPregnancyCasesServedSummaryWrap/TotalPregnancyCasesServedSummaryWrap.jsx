...
import {
  exportDetailExcel as exportDetailExcelApi,
...
function TotalPregnancyCasesServedSummaryWrap({ intl, setNhmDashboardView }) {
  ...
  function handleExport(query) {
    setLoader(true);
    exportDetailExcelApi(query, userConfig.userConfig)
      .then((res) => {
        const fileType = query.fileType;
        const data = res.body;
        const fileName = 'TotalPregnancyCasesServedSummary';
        const metadata = {
  ...
  return (
    <div className="TotalPregnancyCasesServedSummaryWrapper CommonHeader">
...
TotalPregnancyCasesServedSummaryWrap.defaultProps = {
  setNhmDashboardView: () => {},
};

TotalPregnancyCasesServedSummaryWrap.propTypes = {
  intl: PropTypes.object.isRequired,
  setNhmDashboardView: PropTypes.func,
};

export default injectIntl(TotalPregnancyCasesServedSummaryWrap);
