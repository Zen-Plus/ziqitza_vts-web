...
import {
  exportTodayBookedCaseDetail as exportTodayBookedCaseDetailApi
...
function TotalNoOfCasesBookedWrap({ intl, setNhmDashboardView }) {
  ...
  function handleExport(query) {
    setLoader(true);
    exportTodayBookedCaseDetailApi(query, userConfig.userConfig)
      .then((res) => {
        const fileType = query.fileType;
        const data = res.body;
        const fileName = 'TotalNoOfCasesBooked';
        const metadata = {
...
TotalNoOfCasesBookedWrap.defaultProps = {
  setNhmDashboardView: () => {},
};

TotalNoOfCasesBookedWrap.propTypes = {
  intl: PropTypes.object.isRequired,
  setNhmDashboardView: PropTypes.func,
};

export default injectIntl(TotalNoOfCasesBookedWrap);
