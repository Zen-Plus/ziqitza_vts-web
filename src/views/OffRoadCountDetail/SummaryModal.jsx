...
import {
  getOffroadSummaryDocument as getOffroadSummaryDocumentApi,
...
function SummaryModal({ intl, isVisible, onCancelClick, setLoader }) {
  ...
  const {
    ...
    handleSubmit: handleSubmit.bind({ onSubmit: getOffroadSummaryDocument }),
    fields,
    validate: () => {},
  });
  ...
  function getOffroadSummaryDocument(values) {
    setLoader(true);
    getOffroadSummaryDocumentApi({
