...
function Filter({ intl, initialValues, ...restProps }) {
  ...
  return (
    <div className="MedicineInventoryFilterWrap mt-3">
      <div className="Form Border-Gray">
        <div className="row">
          <div className="Field DateRangePickerField JobwiseErrorWrapper col-sm-6 col-lg-4 d-flex justify-content-center mt-2 mt-md-1">
            <DateRangePicker
          ...
          <div className="col-lg-1 col-sm-3 mt-3 mt-sm-4 mt-md-3">
            <ButtonCustom
              className="Box--Shadow Bg-Head-Gray BorderButton"
              onClick={onSubmit}
