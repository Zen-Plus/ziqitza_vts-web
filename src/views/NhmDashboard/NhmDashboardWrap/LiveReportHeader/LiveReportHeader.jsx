...
function LiveReportHeader() {
  return (
    <div className="Header_Wrapper">
      <div className="Header container H-100">
        <div className="row d-flex justify-content-between H-100">
          <div className="col-sm-4 col-md-3 col-4 d-flex justify-content-between Flex-Direction-Column" style={{ paddingTop: '5px', paddingLeft: '2px' }}>
