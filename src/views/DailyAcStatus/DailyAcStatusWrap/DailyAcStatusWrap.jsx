...
import {
  exportDailyAcStatus as exportDailyAcStatusApi
...
function DailyAcStatusWrap({ intl, setNhmDashboardView }) {
  ...
  function handleExport(query) {
    setLoader(true);
    exportDailyAcStatusApi(query, userConfig.userConfig)
      .then((res) => {
        const fileType = query.fileType;
        const data = res.body;
        const fileName = 'DailyAcStatus';
        const metadata = {
...
DailyAcStatusWrap.defaultProps = {
  setNhmDashboardView: () => {},
};

DailyAcStatusWrap.propTypes = {
  intl: PropTypes.object.isRequired,
  setNhmDashboardView: PropTypes.func,
};

export default injectIntl(DailyAcStatusWrap);
