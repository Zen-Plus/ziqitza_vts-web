...
function handleAutoRefereshToggle(event, preValues) {
...
function VtsDashboardSetting({
  ...
  const {
    ...
    fields: {
      ...
      [fieldNames.AUTO_REFRESH]: {
        handleToggle: handleAutoRefereshToggle.bind({ defaultRefreshInterval }),
      },
    },
  ...
  return (
    <Menu className="VtsDashboardSettingWrap">
      <div className="ZiqitzaVTS">
        <div className="VtsSetting VtsDashboardSetting">
...
VtsDashboardSetting.defaultProps = {
  restProps: {},
}

VtsDashboardSetting.propTypes = {
...
export default injectIntl(VtsDashboardSetting);
