...
import {
  exportAverageResponseTimeUrbanRuralSummary as exportAverageResponseTimeUrbanRuralSummaryApi,
...
function AverageResponseTimeUrbanRuralSummaryWrap({ intl, setNhmDashboardView }) {
  ...
  function handleExport(query) {
    setLoader(true);
    exportAverageResponseTimeUrbanRuralSummaryApi(query, userConfig.userConfig)
      .then((res) => {
        const fileType = query.fileType;
        const data = res.body;
        const fileName = 'AverageResponseTimeUrbanRuralSummary';
        const metadata = {
  ...
  return (
    <div className="AverageResponseTimeUrbanRuralSummaryWrapper CommonHeader">
...
AverageResponseTimeUrbanRuralSummaryWrap.defaultProps = {
  setNhmDashboardView: () => {},
};

AverageResponseTimeUrbanRuralSummaryWrap.propTypes = {
  intl: PropTypes.object.isRequired,
  setNhmDashboardView: PropTypes.func,
};

export default injectIntl(AverageResponseTimeUrbanRuralSummaryWrap);
