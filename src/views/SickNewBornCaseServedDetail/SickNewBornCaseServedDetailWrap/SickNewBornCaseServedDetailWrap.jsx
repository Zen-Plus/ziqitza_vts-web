...
function SickNewBornCaseServedDetailWrap({ intl, setNhmDashboardView }) {
  ...
  function handleExport(query) {
    ...
    exportDetailExcelApi(query, userConfig.userConfig)
      .then((res) => {
        ...
        const data = res.body;
        const fileName = 'SickNewBornCaseServedDetail';
        const metadata = {
...
SickNewBornCaseServedDetailWrap.defaultProps = {
  setNhmDashboardView: () => {},
};

SickNewBornCaseServedDetailWrap.propTypes = {
  intl: PropTypes.object.isRequired,
  setNhmDashboardView: PropTypes.func,
};

export default injectIntl(SickNewBornCaseServedDetailWrap);
