...
import {
  exportMonthlyCaseServedDetail as exportMonthlyCaseServedDetailApi
...
function TotalCasesServedSummaryWrap({ intl, setNhmDashboardView }) {
  ...
  function handleExport(query, payload) {
    setLoader(true);
    exportMonthlyCaseServedDetailApi(query, userConfig.userConfig, payload)
      .then((res) => {
        const fileType = query.fileType;
        const data = res.body;
        const fileName = 'TotalCasesServedSummary';
        const metadata = {
  ...
  return (
    <div className="TotalCasesServedSummaryWrapper CommonHeader">
...
TotalCasesServedSummaryWrap.defaultProps = {
  setNhmDashboardView: () => {},
};

TotalCasesServedSummaryWrap.propTypes = {
  intl: PropTypes.object.isRequired,
  setNhmDashboardView: PropTypes.func,
};

export default injectIntl(TotalCasesServedSummaryWrap);
