...
function SeniorCitizenCaseServedDetail(props) {
  ...
  return (
    <div className="Width-Full ZiqitzaVTS">
      ...
      />
      <SeniorCitizenCaseServedDetailWrap
        {...props}
      />
    </div>
  );
...
export default withUserConfigProvider(withIntlProvider(withNotificationProvider(SeniorCitizenCaseServedDetail)));
