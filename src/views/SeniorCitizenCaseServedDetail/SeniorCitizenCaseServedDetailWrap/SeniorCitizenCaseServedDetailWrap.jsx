...
function SeniorCitizenCaseServedDetailWrap({ intl, setNhmDashboardView }) {
...
SeniorCitizenCaseServedDetailWrap.defaultProps = {
  setNhmDashboardView: () => {},
};

SeniorCitizenCaseServedDetailWrap.propTypes = {
  intl: PropTypes.object.isRequired,
  setNhmDashboardView: PropTypes.func,
};

export default injectIntl(SeniorCitizenCaseServedDetailWrap);
